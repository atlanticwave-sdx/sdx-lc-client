...
class Port(object):
    ...
    def __init__(self, id=None, name=None, short_name=None, node=None, label_range=None, status=None, state=None, nni=None, services=None, private_attributes=None):  # noqa: E501
