...
class Link(object):
    ...
    def __init__(self, id=None, name=None, short_name=None, ports=None, bandwidth=None, residual_bandwidth=None, latency=None, packet_loss=None, availability=None, status=None, state=None, private_attributes=None, time_stamp=None, measurement_period=None):  # noqa: E501
